...
while start == 1:
    ...
    if len(found_letters) == 0: #chodzi o to ze found_letters to fukncja która zwraca znalezione indexy (2 dla "a"), i jak dlugosc znalezionych bedzie 0 to znaczy ze nie znalezlismy zadnego czyli nie ma takiej litery w slowie
